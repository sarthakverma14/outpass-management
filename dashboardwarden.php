...
if (isset($_POST['approvebtn'])) {
	$id = $_POST['id'];
	$sql = "UPDATE `info` SET `wardencheck`=1 WHERE `id`='$id'";
...
<html>
   ...
   <body>
   	  <table id="Responsive">
          ...
          // echo $u;
   	     $query = "SELECT id, firstname, lastname, regno, email, blockno, roomno, dateofleave, dateofreturn, phoneno, parentsphoneno, reason, leaveaddress from info where wardencheck = 0";
          // echo $query;
